 ...
 *
 * @package       AIOVG
 * @subpackage    AIOVG/widgets/video
 */
...
class AIOVG_Widget_Video extends WP_Widget {
	...
	public function __construct() {
		...
		$options = array( 
			...
			'description' => __( 'Displays video added using "All-in-One Video Gallery" plugin.', 'all-in-one-video-gallery' ),
		);
	...
	public function form( $instance ) {
		...
		include AIOVG_PLUGIN_DIR . 'widgets/video/templates/admin.php';
	...
	public function enqueue_styles_scripts() {		
		...
		if ( is_active_widget( false, $this->id, $this->id_base, true ) ) {
			...
			wp_enqueue_script( AIOVG_PLUGIN_SLUG );
		}
