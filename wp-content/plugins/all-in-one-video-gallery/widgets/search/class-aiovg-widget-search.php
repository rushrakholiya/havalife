 ...
 *
 * @package       AIOVG
 * @subpackage    AIOVG/widgets/search
 */
...
class AIOVG_Widget_Search extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( $this->widget_slug, __( 'AIOVG - Search Videos', 'all-in-one-video-gallery' ), $options );
	...
	public function widget( $args, $instance ) {
		...
		include apply_filters( 'aiovg_load_template', AIOVG_PLUGIN_DIR . 'public/templates/search-form-' . $attributes['template'] . '.php' );
	...
	public function form( $instance ) {	
        ...
        include AIOVG_PLUGIN_DIR . 'widgets/search/templates/admin.php';
